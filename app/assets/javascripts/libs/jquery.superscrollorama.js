...
(function($) {
  ...
  $.superscrollorama = function(options) {
            ...
            if (repeatIndefinitely) { // if the animation loops indefinitely it will just play for the time of the duration
              ...
              if (animObj.playeadLastPosition === null || playheadPosition === animObj.playeadLastPosition) {
                if (playheadPosition == 1) {
                  ...
                  animObj.tween.reverse();
                  else animObj.tween.totalProgress(0).play();
                } else {
                  animObj.tween.play();
                }
              }
        ...
        for (i = 0; i < numPinned; i++) {
          ...
          if (pinObj.state != 'PINNED') {
            ...
            if (inPinAra || jumpedPast) {
              ...
              if (pinObj.state === "UPDATE") {
                if (pinObj.anim) setTweenProgress(pinObj.anim, 0); // reset the progress, otherwise the animation won't be updated to the new position
          ...
          if (pinObj.state === 'PINNED') {
            ...
            if (currScrollPoint < pinObj.pinStart || currScrollPoint > pinObj.pinEnd) {
              ...
              if (pinObj.onUnpin) pinObj.onUnpin(!before);
            } else if (pinObj.anim) {
              // do animation
    ...
    // PUBLIC FUNCTIONS
    superscrollorama.addTween = function(target, tween, dur, offset, reverse, invalidate) {
